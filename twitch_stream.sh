...
ffmpeg -ar 44100 -ac 2 -acodec pcm_s16le -f s16le -ac 2 -i /dev/zero -f v4l2 -thread_queue_size 10240 -codec:v h264 -s 1280x720 -i /dev/video0 -codec:v copy -codec:a copy -f flv rtmp://ber.contribute.live-video.net/app/$STREAM_KEY
